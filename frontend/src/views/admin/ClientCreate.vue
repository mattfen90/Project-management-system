<template>
  <div class="page">
    <div class="page-intro">
      <p>Fill in the client's details below. Name, email, and type are required.</p>
    </div>
      ...
      <form class="form" @submit.prevent="handleSubmit">
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="clientName" v-model="form.clientName" type="text" placeholder="e.g. John" required />
          </div>
          <div class="form-group">
            <label for="clientSurname">Surname</label>
            <input id="clientSurname" v-model="form.clientSurname" type="text" placeholder="e.g. Smith" />
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="clientEmail" v-model="form.clientEmail" type="email" placeholder="client@example.com" required />
          </div>
          <div class="form-group">
            <label for="clientType">Type <span class="required">*</span></label>
            <input id="clientType" v-model="form.clientType" type="text" placeholder="e.g. Individual, Company" required />
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input id="clientTelephone" v-model="form.clientTelephone" type="text" placeholder="+356 xxxx xxxx" />
          </div>
          <div class="form-group">
            <label for="clientMobile">Mobile</label>
            <input id="clientMobile" v-model="form.clientMobile" type="text" placeholder="+356 xxxx xxxx" />
          </div>
        </div>

        <div class="form-group">
          <label for="clientWebsite">Website</label>
          <input id="clientWebsite" v-model="form.clientWebsite" type="text" placeholder="https://example.com" />
        </div>

        <div class="form-group">
          <label for="clientAddress">Address</label>
          <textarea id="clientAddress" v-model="form.clientAddress" rows="3" placeholder="Full address..."></textarea>
        </div>
        ...
        <div class="form-group">
          ...
          <textarea id="notes" v-model="form.notes" rows="3" placeholder="Any additional notes..."></textarea>
        </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    errorMsg.value = err?.response?.data?.message || 'Failed to create client';
  } finally {
